...
import { GameState, Hand, Object$, Player } from "../resources/game_pb.js";
...
export const GameStatusRequest = /*@__PURE__*/ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "state", kind: "enum", T: proto3.getEnumType(GameState) },
    { no: 3, name: "players", kind: "message", T: Player },
  ],
);
...
export const GameStatusResponse = /*@__PURE__*/ proto3.makeMessageType(
  ...
  () => [
    { no: 1, name: "room_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "state", kind: "enum", T: proto3.getEnumType(GameState) },
    { no: 3, name: "players", kind: "message", T: Player, repeated: true },
    { no: 4, name: "time", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
  ],
);
