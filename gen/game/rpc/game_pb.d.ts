...
import type { GameState, Hand, Object$, Player } from "../resources/game_pb.js";
...
export declare class GameStatusRequest extends Message<GameStatusRequest> {
  ...
  /**
   * @generated from field: game.resources.GameState state = 2;
   */
  state: GameState;

  /**
   * @generated from field: game.resources.Player players = 3;
   */
  players?: Player;
...
export declare class GameStatusResponse extends Message<GameStatusResponse> {
  ...
  /**
   * @generated from field: repeated game.resources.Player players = 3;
   */
  players: Player[];

  /**
   * @generated from field: int32 time = 4;
   */
  time: number;
